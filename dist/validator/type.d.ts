...
export declare type Interface<TypeName extends StringNative, MessageT = unknown> = Validator<unknown, Native<TypeName>, TypeofValidatable<unknown, TypeName, MessageT>> & Message<(result: Omit<Return<any, any, Native<TypeName>>, 'message'>) => MessageT>;
export default class Typeof<TypeName extends StringNative = StringNative, MessageT = unknown> implements Interface<TypeName, MessageT> {
    ...
    constructor(type: TypeName, message: (result: Omit<Return<any, any, Native<TypeName>>, 'message'>) => MessageT);
